...
export const fetchQuestionTopicLinks = () => dispatch => {
  return QuestionTopicLinkApiUtil.fetchQuestionTopicLinks().then(
    questionTopicLinks =>
      dispatch(receiveAllQuestionTopicLinks(questionTopicLinks))
  );
};

export const fetchQuestionTopicLink = id => dispatch =>
  QuestionTopicLinkApiUtil.fetchQuestionTopicLink(id).then(questionTopicLink =>
    dispatch(receiveQuestionTopicLink(questionTopicLink))
  );

export const createQuestionTopicLink = questionTopicLink => dispatch => {
  return QuestionTopicLinkApiUtil.createQuestionTopicLink(
    questionTopicLink
  ).then(question => dispatch(receiveQuestionTopicLink(question)));
};

export const updateQuestionTopicLink = questionTopicLink => dispatch =>
  QuestionTopicLinkApiUtil.updateQuestionTopicLink(
    questionTopicLink
  ).then(updatedQuestionTopicLink =>
    dispatch(receiveQuestionTopicLink(updatedQuestionTopicLink))
  );

export const deleteQuestionTopicLink = id => dispatch =>
  QuestionTopicLinkApiUtil.deleteQuestionTopicLink(id).then(questionTopicLink =>
    dispatch(removeQuestionTopicLink(questionTopicLink))
  );
